...
namespace BannerlordBattleMod
{
    public class BattleDisplayViewModel : ViewModel
    {
		...
		public BattleDisplayViewModel(TroopRoster leftSide, TroopRoster rightSide)
        {
			...
			this.MapSelectionGroup = new MapSelectionViewModel();
		...
		public override void RefreshValues()
		{
			...
			InformationManager.DisplayMessage(new InformationMessage(OtherPartyTroops.Count.ToString()));
			...
			this.TroopsLabel = "Test1";
			this.OtherPartyTroopsLbl = "Test2";
